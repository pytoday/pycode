...
class Dirlist:
    def __init__(self, initdir=None):
        self.top = Tk()
        self.label = Label(self.top, text='Dir Lister v1.0')
        self.label.pack()
        ...
        self.ls = Button(self.bfm, text='List', command=self.dols, activeforeground='white', activebackground='green')
        self.qu = Button(self.bfm, text='Quit', command=self.top.quit, activeforeground='white', activebackground='red')
