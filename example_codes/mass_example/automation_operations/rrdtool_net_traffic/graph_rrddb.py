#!/usr/bin/env python3
# coding=utf-8
# title          :graph_rrddb.py
# description    :generate pic for rrdtool database
# author         :JackieTsui
# organization   :pytoday.org
# date           :2017/12/29 2:20
...
rrdtool.graph("Flow.png", "--start", "-1d", "--vertical-label=Bytes/s",
              ...
              "COMMENT: ",
              "GPRINT: outbits: MAX: Max Out traffic\: %6.2lf %Sbps",  # 绘制出流量最大
              "COMMENT: ",
              "GPRINT: outbits: MIN: MIN Out traffic\: %6.2lf %Sbps\\r")   # 绘制流量最小
